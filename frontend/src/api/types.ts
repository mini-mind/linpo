...
export interface InstanceTokenUsageDailyPoint {
  date: string;
...
export interface InstanceTokenUsageToday {
  input_tokens: number | null;
  output_tokens: number | null;
  total_tokens: number | null;
}

export interface InstanceTokenUsageResponse {
  days: number;
  today: InstanceTokenUsageToday | null;
  daily: InstanceTokenUsageDailyPoint[];
}
...
export interface InstanceFileWriteResponse {
  path: string;
  size_bytes: number;
  updated_at: string;
  exists: boolean;
...
export interface InstanceFileDeleteResponse {
  path: string;
  deleted: boolean;
  updated_at: string;
}
...
export interface FlowDraftPlannerRuntimeItem {
...
export interface FlowDraftItem {
  ...
  planner_runtime?: FlowDraftPlannerRuntimeItem;
  revision: number;
  created_at: string;
  updated_at: string;
}
