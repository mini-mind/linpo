...
from app.services.runtime_environment import get_app_env, is_dev_or_test_env
...
async def lifespan(app: FastAPI):
    ...
    _log_task_run_test_callback_endpoint_status()
    yield
...
def _log_task_run_test_callback_endpoint_status() -> None:
    app_env = get_app_env()
    enabled = is_dev_or_test_env()
    logger.info(
        "startup.task_run_test_callback_endpoint status=%s app_env=%s",
