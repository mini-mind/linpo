...
- Create: `ops/scripts/verify_no_kanban_refs.sh`
...
Save it to `ops/scripts/verify_no_kanban_refs.sh`.

**Step 2: Run test to verify it fails**

Run: `bash ops/scripts/verify_no_kanban_refs.sh`
Expected: Non-zero exit with matches in web-frontend files.

**Step 3: Write minimal implementation**

Remove the Kanban UI from `edge-ui/web-frontend/index.html`, strip Kanban rendering logic and view toggle from `edge-ui/web-frontend/app.js`, and delete Kanban CSS blocks from `edge-ui/web-frontend/style.css`. Update `edge-ui/web-frontend/README.md` and `edge-ui/web-frontend/AGENTS.md` to remove Kanban mentions.
...
```bash
git add edge-ui/web-frontend/index.html edge-ui/web-frontend/app.js edge-ui/web-frontend/style.css edge-ui/web-frontend/README.md edge-ui/web-frontend/AGENTS.md ops/scripts/verify_no_kanban_refs.sh
...
Save it to `ops/scripts/verify_no_state_patch_refs.sh`.

**Step 2: Run test to verify it fails**

Run: `bash ops/scripts/verify_no_state_patch_refs.sh`
...
```bash
git add edge-ui/web-frontend/app.js edge-ui/web-frontend/README.md docs/README.md docs/agent-framework.md ops/scripts/verify_no_state_patch_refs.sh
...
rg -n "schedules|templates|reporting|kanban|mvp2|MVP2" docs api dispatch web-frontend
```

Save it to `ops/scripts/verify_no_legacy_keywords.sh`.

**Step 2: Run test to verify it fails**

Run: `bash ops/scripts/verify_no_legacy_keywords.sh`
...
```bash
git add docs/README.md docs/handoff/worker-development.md docs/prod-deployment.md docs/deployment/local.md ops/scripts/verify_no_legacy_keywords.sh
